...
#import "LFViewerViewController.h"
#import "LFSelectCounterButton.h"
#import "LFImageSelectButton.h"

@interface LFPreviewViewController () <UIPageViewControllerDataSource, UIPageViewControllerDelegate>
...
#pragma mark - 监听方法
- (void)clickSelectedButton:(LFImageSelectButton *)button {
    LFViewerViewController *viewer = _pageController.viewControllers.lastObject;
...
- (void)pageViewController:(UIPageViewController *)pageViewController willTransitionToViewControllers:(NSArray<UIViewController *> *)pendingViewControllers {
    ...
    LFViewerViewController *viewer = (LFViewerViewController *)pendingViewControllers.lastObject;
...
- (nullable UIViewController *)viewerControllerWithViewController:(UIViewController *)viewController isNext:(BOOL)isNext {
    ...
    LFViewerViewController *detail = (LFViewerViewController *)viewController;
...
- (LFViewerViewController *)viewerControllerWithIndex:(NSInteger)index {
    LFViewerViewController *viewer = [[LFViewerViewController alloc] init];
