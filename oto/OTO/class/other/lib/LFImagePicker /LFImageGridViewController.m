...
static NSString *const LFImageGridViewCellIdentifier = @"LFImageGridViewCellIdentifier";

@interface LFImageGridViewController () <LFImageGridCellDelegate, LFPreviewViewControllerDelegate>

@end

@implementation LFImageGridViewController {
    /// 相册模型
    LFAlbum *_album;
    /// 选中素材数组
    ...
    /// 选择计数按钮
    LFSelectCounterButton *_counterButton;
}
...
- (instancetype)initWithAlbum:(LFAlbum *)album
    ...
    LFImageGridViewLayout *layout = [[LFImageGridViewLayout alloc] init];
...
#pragma mark - LFImageGridCellDelegate
...
- (BOOL)previewViewController:(LFPreviewViewController *)previewViewController didChangedAsset:(PHAsset *)asset selected:(BOOL)selected {
    ...
    LFImageGridCell *cell = (LFImageGridCell *)[self.collectionView cellForItemAtIndexPath:indexPath];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    LFImageGridCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:LFImageGridViewCellIdentifier forIndexPath:indexPath];
...
- (void)showPreviewControllerWithIndexPath:(NSIndexPath *)indexPath {
    ...
    LFPreviewViewController *preview = [[LFPreviewViewController alloc]
...
- (void)clickFinishedButton {
    [[NSNotificationCenter defaultCenter] postNotificationName:LFImagePickerDidSelectedNotification object:self userInfo:nil];
}
...
- (void)prepareUI {
    ...
    _counterButton = [[LFSelectCounterButton alloc] init];
    ...
    // 注册可重用 cell
    [self.collectionView registerClass:[LFImageGridCell class] forCellWithReuseIdentifier:LFImageGridViewCellIdentifier];
