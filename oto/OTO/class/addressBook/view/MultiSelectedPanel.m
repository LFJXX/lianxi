...
//    [self.collectionView registerClass:[UICollectionViewCell class] forCellWithReuseIdentifier:@"MultiSelectedPanelTableViewCell"];
    [self.collectionView registerNib:[UINib nibWithNibName:@"AddressCell" bundle:nil] forCellWithReuseIdentifier:@"MultiSelectedPanelTableViewCell"];
...
- (UICollectionViewCell*)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    AddressCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:CellIdentifier forIndexPath:indexPath];
 
    cell.iconView.tag = 999;
    cell.iconView.layer.cornerRadius = 4.0f;
    cell.iconView.clipsToBounds = YES;
    cell.iconView.contentMode = UIViewContentModeScaleAspectFill;

    THContract *item = self.selectedItems[indexPath.row];
    [cell.iconView setImage:item.image];
